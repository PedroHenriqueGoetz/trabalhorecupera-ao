 ...
 * Todas as consultas usam prepared statements, nunca concatenacao de strings.
 */
const UsuarioModel = {
  /**
   * Busca um usuario pelo email (inclui o hash da senha, usado apenas no login).
   * @async
   * @param {string} email
  ...
  /**
   * Busca um usuario pelo id, sem expor a senha.
   * @async
   * @param {number} id
   * @returns {Promise<Object|null>}
   */
